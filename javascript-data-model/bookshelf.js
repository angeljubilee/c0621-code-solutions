...
console.log('Author at bookshelf[1]: ', bookshelf[1].author);
console.log('ISBN at bookshelf[0]: ', bookshelf[0].isbn);
console.log('Title at bookshelf[2]: ', bookshelf[2].title);
